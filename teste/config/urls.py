...
urlpatterns = [
    ...
    path('', TemplateView.as_view(template_name='index.html'), name='index'),  # Mantive a view index aqui
    path('app/', include("app.urls")),  # Alterado para evitar conflitos
    ...
    path('cadastro/investidor/', InvestidorView.as_view(), name='investidor'),  # Renomeado para melhor clareza
    ...
    path('comentario/editar/<int:comentario_id>/', EditarComentarioView.as_view(), name='editar_comentario'),
